...
export const ui = {
	es: {
		...
		'section.about.description.paragraph2.part1':
			'Algunos de mis puntos fuertes incluyen',
		'section.about.description.paragraph2.part2':
			'la recilencia para superar momentos dificiles y seguir creciendo tanto personal como profesionalmente.',
		'section.about.description.paragraph2.part3':
			'Uno de mis logros que destaco fue fomentar el',
		'section.about.description.paragraph2.part4':
			'aprendizaje y las buenas prácticas',
		'section.about.description.paragraph2.part5':
			'de desarrollo entre mis compañeros en mi último empleo.',
		'section.about.description.paragraph3.part1':
			'Me apasiona enfrentar desafíos complejos y brindar soluciones',
		...
		'section.about.description.paragraph3.part5':
			', la calidad y el compromiso con los objetivos del proyecto.',
	...
	en: {
		...
		'section.about.description.paragraph2.part3':
			'One of my achievements that I am proud of is fostering the',
		'section.about.description.paragraph2.part4': 'learning and best practices',
		'section.about.description.paragraph2.part5':
			'of development among my colleagues in my last job.',
		'section.about.description.paragraph3.part1':
			'I love facing complex challenges and providing solutions',
		...
		'section.about.description.paragraph3.part5':
			", The quality and commitment to the project's objectives.",
